...
const formatMovementDate = (currentAccount, date) => {
  ...
  // }
  // no need of options to display just date
...
const logOutTimer = () => {
  ...
  tick(); //calling immediatly for the first time bcz setinterval will call it after 1 sec
...
btnLogin.addEventListener("click", function (e) {
  ...
  if (currentAccount?.pin === Number(inputLoginPin.value)) {
    ...
    const locale = currentAccount.locale; //navigator.language  'en-US' or 'en-Uk' etc
